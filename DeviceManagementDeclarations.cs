...
namespace SMDProfiler
{
	internal sealed partial class DeviceManagement
	{
		...
		internal const Int32 DBT_DEVICEREMOVEPENDING = 0X8003;
		internal const Int32 DBT_DEVICEQUERYREMOVE = 0X8001;
		...
		internal const Int16 SPDRP_FRIENDLYNAME = 0x0000000C;
		internal const Int16 SPDRP_PHYSICAL_DEVICE_OBJECT_NAME = 0x0000000E;
		...
		[DllImport("setupapi.dll", SetLastError = true)]
		internal static extern Boolean SetupDiEnumDeviceInfo(IntPtr DeviceInfoSet, Int32 MemberIndex, ref SP_DEVINFO_DATA DeviceInfoData);

		[DllImport("setupapi.dll", SetLastError = true)]
		internal static extern Boolean SetupDiGetDeviceRegistryProperty(IntPtr DeviceInfoSet, ref SP_DEVINFO_DATA DeviceInfoData, Int16 Property, out Int32 PropertyRegDataType, byte[] PropertyBuffer, Int16 PropertyBufferSize, out Int32 RequiredSize);
	}
}
